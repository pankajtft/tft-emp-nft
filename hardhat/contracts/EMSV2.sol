...
//     function safeMint(string memory uri, uint32 empID) external;

//     function burn(uint32 empID) external;

//     function setURI(uint32 empId, string memory uri) external;
// }

contract EMSV2 is IERC721Receiver {
    ...
    //     NFT = NFTcontract(0x98409b134F3B55F97Fcde15fBC03E809f118Ea51);
    //     _owner = msg.sender;
    // }
    ...
    function mintEmployeeNFT(
        ...
        uint32 empId
    ) public nonReentrant onlyOwner validEmpId(empId) {
        require(
    ...
    ) external nonReentrant onlyOwner validEmpId(empId) {
    ...
    //Pure/View Functions
    // function getNFT() public view onlyOwner returns (address) {
    //     return NFT;
    // }
